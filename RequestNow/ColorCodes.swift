...
extension ColorCodes {
    func color() -> Color {
        ...
        case .lighterShadeOfDarkGrey: return Color(red: 60/255, green: 65/255, blue: 72/255)
    ...
    func uicolor() -> UIColor {
        ...
        case .lighterShadeOfDarkGrey: return UIColor(red: 60/255, green: 65/255, blue: 72/255, alpha: 1.0)
